...
<h3 align="center"> Мне 26 лет, и я живу в Казани :) </h3>
<h3 align="center"> Data Scientist</h3>
<h3 align="center"> В данном репозитории проекты, реализованные в рамках профессии "Специалист по Data Science"</h3>

## ML projects
|№| Название | Описание | 
|:---|:-------------------|:----------------------------------------------------------|
|14  |Сервис для мониторинга своевременной оплаты аренды гаража| Отслеживать платежи за аренду гаража и посылать уведомления в телеграм бот, если платежи просрочены|
|13  |Предсказание оттока клиентов| Обучить на предоставленных заказчиком данных модель, которая будет прогнозировать отток клиентов (Модель логистической регрессии и градиентный бустинг).|
