...
|№| Название | Описание | 
|:---|:-------------------|:----------------------------------------------------------|
|13  |[Предсказание оттока клиентов]((https://github.com/rgnrmnv/DS_projects/tree/main/13.%20customers_churn_prediction)| Обучить на предоставленных заказчиком данных модель, которая будет прогнозировать отток клиентов (Модель логистической регрессии и градиентный бустинг).|
